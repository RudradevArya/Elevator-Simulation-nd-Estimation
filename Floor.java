...
public class Floor {
    ...
    /**
     * Create a Passenger object (simulating a passenger arriving at a floor and pressing a button). and generate passenger ID.
     *
     ...
     * Randomly selecting the floor number for exitFloor, also checking the floor number is
